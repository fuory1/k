...
- [Gemini (Google Generative AI)](https://ai.google.dev/) - Default AI provider
- [Groq](https://console.groq.com/) - Default AI provider
...
For optional features configuration (Redis, SearXNG, OpenAI, etc.), see [CONFIGURATION.md](./docs/CONFIGURATION.md)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmiurla%2Fmorphic&env=GOOGLE_GENERATIVE_AI_API_KEY,GROQ_API_KEY,TAVILY_API_KEY,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN)
